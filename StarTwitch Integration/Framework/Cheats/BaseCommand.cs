...
namespace StarTwitch_Integration.Framework.Cheats
{
    ...
    internal abstract class BaseCommand : OutputInterface
    {
        /*********
        ** Public methods
        *********/
        ...
        public abstract IEnumerable<OptionsElement> GetFields(ContextMeta context);
        ...
        public virtual void OnConfig(ContextMeta context, out bool needsInput, out bool needsUpdate, out bool needsRendering)
        {
            needsInput = false;
            needsUpdate = false;
        ...
        /// <param name="context">The cheat context.</param>
        public virtual void OnSaveLoaded(ContextMeta context) { }
        ...
        public virtual void OnRendered(ContextMeta context, SpriteBatch spriteBatch) { }
