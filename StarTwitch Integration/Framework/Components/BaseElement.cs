...
namespace StarTwitch_Integration.Framework.Components
{
    ...
    internal abstract class BaseElement : OptionsElement
    {
        /*********
        ** Protected methods
        *********/
        ...
        protected BaseElement(string label)
            : base(label) { }
        ...
        protected BaseElement(string label, int x, int y, int width, int height, int whichOption = -1)
