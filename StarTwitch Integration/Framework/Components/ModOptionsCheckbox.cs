...
namespace StarTwitch_Integration.Framework.Components
{
    ...
    internal class ModOptionsCheckbox : BaseOptionsElement
    {
        /*********
        ** Fields
        *********/
        ...
        *********/
        ...
        public ModOptionsCheckbox(string label, bool value, Action<bool> setValue)
        ...
        public override void receiveLeftClick(int x, int y)
        {
            ...
            Game1.playSound(IsChecked ? "drumkit6" : "breathin");
        }
